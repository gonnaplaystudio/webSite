  ...
  <div class="container-md">
    ...
    <form  method="POST" action="add_news.php">
      ...
      <div class="col-lg-6">
          <fieldset>
            <div class="form-border-back">
              <legend class="tittle-form-back">AÑADIR NOTICIA ES</legend>
                <div class="form-group contenedor-inputs text-center">
                  ...
                  <div class="i-48">
                    ...
                    <input type="text" class="form-control" id="img_scr_es" name="img_scr_es" >
                  </div>
                  <div class="i-100">
      ...
      <div class="col-lg-6">
          <fieldset>
            <div class="form-border-back">
              <legend class="tittle-form-back">AÑADIR NOTICIA ENG</legend>
                <div class="form-group contenedor-inputs text-center">
                  ...
                  <div class="i-48">
                    ...
                    <input type="text" class="form-control" id="img_scr_eng" name="img_scr_eng" >
                  </div>
                  <div class="i-100">
        ...
        <div class="row margin-600">
          <div class="col mt-4">
            <button type="submit" class="btn btn-secondary mx-auto d-block" onclick="return validar_add_news()">AÑADIR</button>            
          </div>
      </div>
    </form>        
