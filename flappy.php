<?php
    ...
    //SELECT GAMES
    $game_alias="Flappy World";//cambiar por cada página del juego
        ...
        <div class="collapse navbar-collapse nav-links" id="navbarColor01">
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-lg-end dropdown-menu-dark">
              <li>
                <a class="dropdown-item-custom" href="flappy.php?lang=eng">
              ...
              <li>
                <a class="dropdown-item-custom" href="flappy.php?lang=es">
                ...
                <div class="border-rrss">
                    ...
                    <div class="row margin-bottom-un">
                        <div class="d-flex justify-content-center col">
                            <a href="#"><img src="img/flappy/play_store.png" class="logos-store" alt="..."></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/flappy/flappy_web_2.jpg" class="d-block w-100  border-radius" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/flappy/flappy_web_1.jpg" class="d-block w-100 border-radius" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/flappy/flappy_web_3.jpg" class="d-block w-100 border-radius" alt="...">
                        </div>
                    </div>
