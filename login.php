    ...
    <div class="row margin-600">        
      <form  method="POST" action="login_ver.php">
        <fieldset>
          ...
          <legend class="tittle-form">IDENTIFICATE</legend>
              <div class="form-group info-margin">
                <input type="text" class="form-control car-margin" name="usuario" id="usuario" placeholder="Usuario*">
                <input type="password" class="form-control" name="clave" id="clave" placeholder="Contraseña*">
                <div id="errores" class="text-danger"></div>
              </div>
            <button type="submit" class="btn btn-secondary mx-auto d-block">ACCEDER</button>
          </div>
        </fieldset>
      </form>          
    </div>
